...
- Current focus: keep the static app deployable while using the normalized repo-native operating layer, commit-backed execution history, and enforced commit provenance workflow
...
Whimbrel is an active static GitHub Pages application built from hand-authored HTML, CSS, and JavaScript at the repo root. It remains deployable without a build step. This repo now has a normalized repo-template operating layer with thin `AGENTS.md` and `CLAUDE.md` entrypoints, local writing-guide enforcement through directory `README.md` files, commit-backed execution history, and commit provenance checks in both local Git hooks and CI. The older `logs/` folder remains preserved as legacy context.
...
- Goal: keep future repo work routed into canonical docs, research memos, decision records, and commit-backed execution history
- Status: `done`
- Why this matters now: Whimbrel previously had useful notes but no single operating model for future maintenance
- Current work: canonical docs, migrated research memos, thin agent entrypoints, normalized writing guides, commit provenance checks, a local orchestration skill, and commit-backed LOG records
...
- Related ids: `DEC-20260409-001`, `DEC-20260409-002`, `RSH-20260409-001`, `RSH-20260409-002`, `RSH-20260409-003`

## Recent Changes To Project Reality

- Date: `2026-04-09`
  - Change: adopted a repo-native operating model with canonical truth, status, planning, research, decisions, and commit-backed execution history
...
- Blocker or risk: missing automated end-to-end or unit coverage for Web Serial and DFU flows
  ...
  - Mitigation: keep runtime changes deliberate, capture them in commit-backed `LOG-*` records, and add tests only when the repo accepts that investment
